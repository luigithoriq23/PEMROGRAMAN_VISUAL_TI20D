...
Public Class FormUser
    ...
    Private Sub txtPSSWD_TextChanged(sender As Object, e As EventArgs) Handles txtPSSWD.TextChanged
    ...
    Private Sub rbPenyewa_CheckedChanged(sender As Object, e As EventArgs) Handles rbPenyewa.CheckedChanged
