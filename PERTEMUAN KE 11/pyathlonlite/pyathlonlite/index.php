            ...
            <table class="table custom-table">
                ...
                ?>
                    <tr scope="row">
                        ...
                        <td>
                            <a href="http://localhost/pyathlonlite/gen_php_class.php?table=<?php echo $row[0]; ?>" target="_blank">PHP Class</a> | 
                            <a href="http://localhost/pyathlonlite/gen_php_api.php?table=<?php echo $row[0]; ?>" target="_blank">PHP API</a> |
